...
import com.hybe.hybef.databinding.ActivityBtsBinding
import java.util.*

class BtsActivity : AppCompatActivity() {
    private lateinit var binding: ActivityBtsBinding
    ...
    val urls = listOf(
        ...
        "https://youtu.be/rpY2ogMpCvg",
        "https://youtu.be/JDcXtcAOhXE",
        "https://youtu.be/U5EMWQ_Mtk0",
        "https://youtu.be/GfX62fI1NyA",
        "https://youtu.be/AX0CIHA2f1M",
        "https://youtu.be/w5XxXWJrARU",
    )

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = DataBindingUtil.setContentView(this, R.layout.activity_bts)

        Glide.with(this).load(R.raw.btscd).into(binding.btsImg)
    ...
    fun getCommentData(key: String) {
        ...
        FBRef.btsRef.child(key).addValueEventListener(postListener)
    }
    ...
    class ImageAdapter(
        ...
        override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BtsActivity.ImageAdapter.ViewHolder {
            val view =
